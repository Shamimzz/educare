            ...
            <Col>
             ...
             <Col>
              <div className="mt-2">
                ...
                <p><Link  to="*" className="text-light p-2 mr-5 text-decoration-none" >SEO Business</Link></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Digital Marketing</Link></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Graphic Design</Link></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Social Marketing</Link></p>
             </div>
             </Col>
             <Col>
              <div className="mt-2">
                <p className="text-light p-2 mr-5 text-decoration-none"><h4>Legal</h4></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Terms & Condition</Link></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Privacy policy</Link></p>
                <p><Link to="*" className="text-light p-2 mr-5 text-decoration-none" >Return policy</Link></p>              
             </div>
             </Col>         
          </Row> 
